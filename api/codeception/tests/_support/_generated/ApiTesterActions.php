<?php  //[STAMP] 1c5416a25de6adafd126900cc66e4bed
...
trait ApiTesterActions
{
     ...
     *
     *
     * @see \Helper\generateArtifacts::generateThng()
     */
     ...
     *
     *
     * @see \Helper\generateArtifacts::generateProduct()
     */
    public function generateProduct($lenght) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('generateProduct', func_get_args()));
    }
}
