<?php  //[STAMP] bb270f109948442105325faf7e192f26
...
trait AcceptanceTesterActions
{
     ...
     * @see \Helper\ConfigHelper::getConfig()
     */
    public function tryToGetConfig($key) {
        return $this->getScenario()->runStep(new \Codeception\Step\TryTo('getConfig', func_get_args()));
    }    
    /**
     * [!] Method is generated.
     * 
     * * Executes getConfig and retries on failure.
     * 
     * Retry number and interval set by $I->retry();
     *
     * @see \Helper\ConfigHelper::getConfig()
     */
    public function retryGetConfig($key) {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
        return $this->getScenario()->runStep(new \Codeception\Step\Retry('getConfig', func_get_args(), $retryNum, $retryInterval));
    }
     ...
     *
     *
     * @see \Helper\generateThng::generateThng()
     */
    public function generateThng($lenght) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('generateThng', func_get_args()));
    }
    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     ...
     * @see \Helper\generateThng::generateThng()
     */
    public function tryToGenerateThng($lenght) {
        return $this->getScenario()->runStep(new \Codeception\Step\TryTo('generateThng', func_get_args()));
    }    
    /**
     * [!] Method is generated.
     * 
     * * Executes generateThng and retries on failure.
     * 
     * Retry number and interval set by $I->retry();
     *
     * @see \Helper\generateThng::generateThng()
     */
    public function retryGenerateThng($lenght) {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
        return $this->getScenario()->runStep(new \Codeception\Step\Retry('generateThng', func_get_args(), $retryNum, $retryInterval));
    }
}
